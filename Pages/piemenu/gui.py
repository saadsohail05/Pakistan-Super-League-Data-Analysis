...
def run_gui_script1():
    script_path = CURRENT_DIR.parent.parent / "Piechart" / "pie1.py"
    subprocess.Popen(['python', str(script_path)])
def run_gui_script2():
    script_path = CURRENT_DIR.parent.parent / "Piechart" / "pie2.py"
    subprocess.Popen(['python', str(script_path)])
def run_gui_script3():
    script_path = CURRENT_DIR.parent.parent / "Piechart" / "pie3.py"
    subprocess.Popen(['python', str(script_path)])
def run_gui_script4():
    script_path = CURRENT_DIR.parent.parent / "Piechart" / "pie4.py"
    subprocess.Popen(['python', str(script_path)])
